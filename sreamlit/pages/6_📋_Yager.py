...
with st.expander(" 2. Yager algorithm που περιλαμβάνει συνδυασμό ασθενών διατάξεων μεταξύ επιλογών"):  
  ...
  st.markdown('Στην παραπάνω εικόνα διακρίνεται ότι ο πράκτορας P1 έχει κατατάξει την επιλογή a και b στην 6η θέση. Ο πράκτορας P3 έχει κατατάξει την επιλογή f και e στην 1η θέση και ο πράκτορας P4 κατατάξει την επιλογή a και b στην 5η θέση. Κατά την υλοποίηση του αλγορίθμου, τα βήματα ακολουθούνται κανονικά όπως τον απλό αλγόριθμο του Yager. Η διαφοροποίηση είναι ότι στην λίστα κοινής διάταξης προτίμησης οι επιλογές που έχουν ασθενή διάταξη μεταξύ τους, τοποθετούνται στην ίδια θέση κατάταξης. Κατά την επανάληψη 1 στην παρακάτω εικόνα του παραδείγματος, τα στοιχεία a και b τοποθετούνται μαζί στην ίδια θέση της λίστας κοινής διάταξης προτίμησης.')
